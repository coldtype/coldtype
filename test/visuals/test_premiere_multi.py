...
def t1(f):
    ...
    return P().text(str(f.i), Style("Times", 100, load_font=0), f.a.r.inset(50).offset(0, 500)) + (cg
...
def t2(f):
    ...
    return P().text(str(f.i), Style("Times", 100, load_font=0, fill=hsl(0.3)), f.a.r.inset(50, 50)) + (cg
        .pens(f, render_clip, f.a.r)
        .xa()
        .align(f.a.r)
        .translate(0, -200)
