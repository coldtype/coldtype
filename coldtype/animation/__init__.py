...
class Frame():
    ...
    Frame is the type of the first argument passed to all @animation rendering functions, usually abbreviated as i
    """
    def __init__(self, i, animation:animation):
        self.i = i #: index of the frame
        self.a:animation = animation #: the animation (or subclass of animation) associated with the frame