...
drums = MidiReader2(__sibling__("media/808.mid"),
    duration=120, bpm=120, fps=30, lookup={
        "KD": 36,
        "RS": 39,
        "SD": 40,
        "HT": 43,
...
@animation(timeline=drums, audio=wav)
def drummachine(f):
    kick = drums.ki("KD", f.i)
    cowbell = drums.ki("CW", f.i)
